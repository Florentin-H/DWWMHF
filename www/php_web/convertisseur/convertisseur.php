...
<body>
    ...
    $changes = array(
        "dollars Américain" => 1.04,
        "dollars Canadien" => 1.38,
        "yen" => 144.92753,
        "peso" => 20.04,
        "livre Sterling" => 0.87,
        "roupie" => 83.64,
        ...
        <div class="convertisseur ">
            ...
            <form action="convertisseur.php" method="POST" class="form-group">
                ...
                <div class="montant-parent">
                    ...
                    <input type="number" name="euro" class="form-control" value="<?= $_POST['euro'] ?>" id="inputMontant" />
                </div>
            ...
            <div class="montant-parent">
                <p>Résultat: <?= $resultat . " " . $_POST["currency"] ?></p>
